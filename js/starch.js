...
// 			define(arguments.constructor.prototype, methods[i], Array.prototype[methods[i]])
// 		}
// 		if (NodeList.prototype.hasOwnProperty(methods[i]) === false) {
// 			define(NodeList.prototype, methods[i], Array.prototype[methods[i]])
// 		}
// 	}
// }())
// function Nihil() {}
...
// 	// }
// })
function define(ob, nm, fn) {
	Object.defineProperty(ob, nm, {
		configurable: true,
		enumerable: true,
		writable: true,
		value: fn
...
// define(Object.prototype, "forEach", function(callback, scope) {
// 	var collection = this, index = 0, prop, i
...
// 	}
// })
// define(Object.prototype, "each", Object.prototype.forEach)
